                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="card br-card-deskripsi-guru mt-md-3 mt-lg-0 mt-3">
                            <h4 class="br-tentang-saya ml-3 mt-3">Tentang Saya</h4>
                            <hr>
                            <p class="text-left ml-4 br-deskripsi-guru text-justify">
                                {{ $mentor->deskripsi }}
                            </p>
                        </div>
                    </div>
        ...
        <section class="sec-data-guru mt-5">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 mt-sm-3 mt-3 mt-lg-0 mt-xl-0">
