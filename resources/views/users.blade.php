...
{{--<div class="animated fadeIn">
    <!-- Widgets  -->
    <p>Hai {{ Auth::user()->name }}, Semangat ya belajar nya!</p>
    <!-- /Widgets -->
    <!--  /Traffic -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($query->transaction_status == 'PENDING')
                                                    <span class="badge badge-info">{{ $query->transaction_status }}</span>
                                                @elseif($query->transaction_status == 'SUCCESS')
                                                    <span class="badge badge-success">{{ $query->transaction_status }}</span>
                                                @else
                                                    <span class="badge badge-danger">{{ $query->transaction_status }}</span>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
            ...
            <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle" style="color:yellow;">Silahkan Lengkapi Profile mu</h5>
      ...
      <!-- Earnings (Monthly) Card Example -->
        <div class="col-xl-3 col-md-6 mb-4">
            ...
            <div class="card-body">
                ...
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1" data-toggle="tooltip" title="Kelas Premium {{ $total1 }} dan Kelas Gratis {{ $total2 }}">Kelas Anda</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $total1 + $total2 }}</div>
                    ...
                    {{--<span class="tooltiptext">hai</span>--}}
                </div>
                <div class="col-auto">
      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-danger shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Transaksi Gagal</div>
