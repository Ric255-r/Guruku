...
<div class="card">
    <div class="card-header">
        <strong>Tambah Video Paket</strong>
    </div>
    <div class="card-body card-block">
        <form action="{{ route('videopaket.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="pelajaran" class="form-control-label">Nama Paket</label>
